    ...
    entries: [
      {
        id: "tx-1",
        date: "2026-04-12",
        particulars: "Sales Invoice - Order SIN-2026-081",
        vchType: "Sales Invoice",
        vchNo: "INV/2026-27/004",
        debit: 485000,
        credit: null,
      },
      {
        id: "tx-2",
        date: "2026-05-05",
        particulars: "Payment Received via RTGS (UTR# 982103984)",
        vchType: "Receipt",
        vchNo: "REC-2605-01",
        debit: null,
        credit: 300000,
        remarks: "Part payment for INV 004",
      },
      {
        id: "tx-3",
        date: "2026-06-18",
        particulars: "Sales Invoice - Order CRO-2026-112",
        vchType: "Sales Invoice",
        vchNo: "INV/2026-27/012",
        debit: 320000,
        credit: null,
      },
      {
        id: "tx-4",
        date: "2026-07-10",
        particulars: "Payment Received via NEFT (Ref: AXIS99214)",
        vchType: "Receipt",
        vchNo: "REC-2607-08",
        debit: null,
        credit: 350000,
        remarks: "Clearance payment",
      },
    ],
  },
  "Fashion Matrix Private Ltd": {
    ...
    entries: [
      {
        id: "tx-10",
        date: "2026-04-20",
        particulars: "Sales Invoice - Men Linen Shirts PO-882",
        vchType: "Sales Invoice",
        vchNo: "INV/2026-27/008",
        debit: 620000,
        credit: null,
      },
      {
        id: "tx-11",
        date: "2026-05-22",
        particulars: "Payment Received via RTGS",
        vchType: "Receipt",
        vchNo: "REC-2605-19",
        debit: null,
        credit: 500000,
    ...
    entries: [
      {
        id: "tx-20",
        date: "2026-04-15",
        particulars: "Sales Invoice - Denim Jackets LOT-54",
        vchType: "Sales Invoice",
        vchNo: "INV/2026-27/006",
        debit: 740000,
        credit: null,
      },
      {
        id: "tx-21",
        date: "2026-05-30",
        particulars: "Payment Received via Cheque #49281",
        vchType: "Receipt",
        vchNo: "REC-2605-30",
        debit: null,
        credit: 600000,
