...
const MODEL_FIELDS_MAP: Record<string, string[]> = {
  ...
  factory: ["id", "name", "code", "location", "address", "gstin", "state", "stateCode", "contactPerson", "contactEmail", "contactPhone", "complianceGrade", "totalCapacityMonthly"],
  ...
  testingRequirement: ["id", "purchaseOrderId", "category", "parameter", "product", "requirement", "testMethod", "notes"],
  ...
  factoryCommissionRate: ["id", "factoryName", "commissionRatePct"],
  invoice: ["id", "invoiceNumber", "invoiceType", "partyType", "partyName", "partyGstin", "partyAddress", "partyEmail", "invoiceDate", "dueDate", "currency", "subtotal", "cgstRate", "cgstAmount", "sgstRate", "sgstAmount", "igstRate", "igstAmount", "grandTotal", "paidAmount", "paymentDate", "balanceAmount", "paymentStatus", "notes"],
  ...
  factoryLedgerOpeningBalance: ["id", "factoryName", "fiscalYear", "openingBalance"],
  ...
  staffMember: ["id", "staffCode", "fullName", "designation", "department", "dateOfJoining", "phone", "email", "baseSalary", "hra", "allowances", "fuelAllowance", "vehicleMileage", "bankAccount", "panNumber", "isActive"],
  attendanceRecord: ["id", "staffId", "attendanceDate", "status", "inTime", "outTime", "overtimeHours", "notes"],
  salarySlip: ["id", "staffId", "salaryMonth", "workingDays", "presentDays", "basicPay", "hra", "allowances", "mileageKm", "fuelRate", "fuelCharge", "overtimePay", "grossSalary", "pfDeduction", "esiDeduction", "tdsDeduction", "advanceRecovery", "totalDeductions", "netSalary", "paymentStatus", "paymentDate"],
  advancePayment: ["id", "staffId", "advanceDate", "amount", "repaymentMonths", "monthlyDeduction", "repaidAmount", "balanceAmount", "status", "reason", "deductionHistory"],
};
...
export const db = {
  ...
  testingRequirements: new BackendDbTable("testingRequirement"),
  ...
  ledgerOpeningBalances: new BackendDbTable("factoryLedgerOpeningBalance"),
  ...
  factoryCommissionRates: new BackendDbTable("factoryCommissionRate"),
  ...
  fabricStatus: new BackendDbTable("qcInspection"),
  measurementSpecs: new BackendDbTable("qcInspection"),
  patternFiles: new BackendDbTable("qcInspection"),
  ...
  artworkFiles: new BackendDbTable("qcInspection"),
  documentationFiles: new BackendDbTable("qcInspection"),
